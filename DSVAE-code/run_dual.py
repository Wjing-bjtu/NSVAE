...
parser.add_argument('--lr', type=float, default=1e-3)#5e-4  1e-3
...
#model_best = VAE(**PARAMS).to(device)
...
for epoch in range(args.n_epochs):
   ...
   # nni.report_intermediate_result(valid_scores[-1])
...
print('final_scores',final_scores[0])
#nni.report_final_result(final_scores[0])
