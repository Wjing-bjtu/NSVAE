...
train_mask1, train_mask2 = mask_percent(data_all, data_sub1,data_sunb2, 0.6)
...
metrics = [{'metric': ndcg, 'k': 25},{'metric': ndcg, 'k': 100}]
...
test_metrics = [{'metric': ndcg, 'k': 25}, {'metric': ndcg, 'k': 50}, {'metric': ndcg, 'k': 100}, {'metric': recall, 'k': 25}, {'metric': recall, 'k': 50}]
final_scores = evaluate(model_best, test_in_data, test_out_data, train_mask1, train_mask2, 1, test_metrics)

for metric, score in zip(test_metrics, final_scores):
    print(f"{metric['metric'].__name__}@{metric['k']}:\t{score:.4f}")

print('0.3384 0.3773, 0.3842, 0.4939')